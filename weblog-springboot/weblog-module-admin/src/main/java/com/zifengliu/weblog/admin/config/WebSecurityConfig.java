...
import com.zifengliu.weblog.jwt.config.JwtAuthenticationSecurityConfig;
import com.zifengliu.weblog.jwt.filter.TokenAuthenticationFilter;
import com.zifengliu.weblog.jwt.handler.RestAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()  // 跨域支持
                ...
                .antMatchers("/admin/ai/chat").authenticated()
